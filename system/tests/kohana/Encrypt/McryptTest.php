...
/**
 * Tests the Encrypt_Mcrypt class.
 *
 * @group kohana
 * @group kohana.core
 * @group kohana.core.encrypt
 * @group kohana.core.encrypt.mcrypt
 *
 * @package     Kohana
 * @category    Tests
 * @author      Kohana Team
...
class Kohana_Encrypt_McryptTest extends Unittest_TestCase
{
     ...
     */
    public function testEncode($mode, $cipher, $key, $iv, $txtPlain, $txtEncoded)
    {
     ...
     * @covers Encrypt_Mcrypt::decode
     */
    public function testDecode($mode, $cipher, $key, $iv, $txtEncoded, $txtPlain)
    {
        if (PHP_VERSION_ID >= 70100) {
            $this->markTestSkipped();
        }
     ...
     *
     * @return  array   Array of $key, $mode, $cipher, $txtPlain.
     */
     ...
     * @covers Encrypt_Mcrypt::decode
     */
    public function testEncodeDecode($key, $mode, $cipher, $txtPlain)
    {
        if (PHP_VERSION_ID >= 70100) {
            $this->markTestSkipped();
        }
     ...
     *
     * @return  array   Array of $key, $mode, $cipher, $txtInvalidEncoded.
     */
     ...
     *
     * @dataProvider providerDecodeInvalidData
     */
    public function testDecodeInvalidData($key, $mode, $cipher, $txtInvalidEncoded)
    {
        if (PHP_VERSION_ID >= 70100) {
            $this->markTestSkipped();
        }
     ...
     * @covers Encrypt_Mcrypt::encode
     */
    public function testConsecutiveEncodeProduceDifferentResults($key, $mode, $cipher, $txtPlain)
    {
        if (PHP_VERSION_ID >= 70100) {
            $this->markTestSkipped();
        }
